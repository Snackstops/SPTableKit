...
#ifndef SPTableKitConfig_h
#define SPTableKitConfig_h
...
///若SPBaseTableView无法自动获取cell高度（spdata有值即可），且用户未自定义高度，则使用默认高度
